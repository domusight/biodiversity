...
_ZIP = os.path.join(os.path.dirname(__file__), "..", "qgis", "biodiversity_potential-0.2.0.zip")
_CITY_ZIP = os.path.join(os.path.dirname(__file__), "..", "qgis", "biodiversity_potential-city-0.2.0.zip")
