...
| OS Open Rivers | Surface centrelines only. Links with `fictitious` true, or a level that says underground, culvert, or tunnel, are left out. Buffered by the assumed width, default 8 m. | Open Government Licence. [OS Data Hub](https://osdatahub.os.uk/downloads/open/OpenRivers). |
